...
--
--	The date: 2016-09-17
--	This sql script is for COMP2714 Database Assignment 01.
--  This sql script is written by Hansol Lee
--
--	This command enables SQL*Plus to print all output messages
--  into a spool file.
SET ECHO ON
--
-- ---------------------------------------------------------
-- This command tells SQL*Plus to open the file
--
SPOOL C:\Users\Kunlaya\workspace\COMP2714\Assignments\Asn1_HerraduraL_KobunnoiK.txt
--
-- ---------------------------------------------------------
--  COMP 2714
--  SET 2C
...
-- ---------------------------------------------------------
--  START C:\Users\Kunlaya\workspace\COMP2714\Assignments\Asn1_HerraduraL_KobunnoiK.sql
-- ---------------------------------------------------------
--
...
FROM DUAL;
-- ---------------------------------------------------------
--  Questions: Given the following database tables required
--
...
;
-- ---------------------------------------------------------
-- Q4) Insert 3 rows of sample data to each of the 4 tables.
-- ---------------------------------------------------------
-- Insert HOTEL Data
INSERT INTO Hotel
...
;
INSERT INTO Booking
  VALUES ('J003', '00111104', DATE'2016-10-10', DATE'2016-10-15','40')
;
COMMIT;
--
-- ---------------------------------------------------------
